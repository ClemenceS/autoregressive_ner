strings={
    "en":{
        ...
        'ner_tags_names' : {
            ...
            'Biblio' : "a bibliography",
            'Data' : "a data",
            'File' : "a file",
            'Database' : "a database",
            'Environment' : "an environment",
            'Container' : "a container",
            'ManagementSystem' : "a management system",
            'LibraryPackage' : "a library packages",
            'ProgrammingLanguage' : "a  programming languages",
            'Hardware' : " a hardware",
            'Method' : "a method",
        ...
        'ner_tags_description' : {
            ...
            # add biotoflow
            "Tool": "These are bioinformatics tools.",
            "Version": "These represent the version of a specific tool or software.",
            "Description": "These provide detailed explanations or summaries.",
            "Parameter": "These are variables used to customize bioinforamtic tools.",
            "Biblio": "These are collections of bibliographic references.",
            "Data": "These are datas used in the bioinformatic workflows.",
            ...
            "Hardware": "These are physical components of a computer or system.",
            "Method": "These are the descriptions of specific points in the workflow.",
            "WorkflowName": "These are names given to the bioinformatic worklows.",
            }
    },
    "fr":{
