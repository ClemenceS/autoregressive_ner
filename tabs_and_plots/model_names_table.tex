...
\cmidrule{2-6}
 & 2 & Llama-3-8B-Instruct\textsuperscript{\texttt{[en]}} & 8B & over 15 trillion tokens & "A new mix" of publicly available online data, mainly in English \\
\cmidrule{2-6}
 & 3 & Mistral-7B\textsuperscript{\texttt{[?]}} \cite{jiang2023mistral} & 7B & Undisclosed & Undisclosed \\
\cmidrule{2-6}
 & 4 & Phi-3-medium-instruct\textsuperscript{\texttt{[en]}} \cite{abdin2024phi} & 14B & 4.8 trillion tokens & A combination of publicly available corpora, synthetic data and chat format supervised data, mainly in English \\
\cmidrule{2-6}
...
\cmidrule{2-6}
 & 11 & BioMistral-7B\textsuperscript{\texttt{[en]}}* \cite{labrak2024biomistral} & 7B & 3 billion tokens & Mistral, fine-tuned on the PMC Open Access Subset \\
\cmidrule{2-6}
