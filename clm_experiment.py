...
if "opt-66b" in args.model_name and "WikiNER/es" in args.dataset_name:
    kept_features = {'n_few_shot': 10, 'one_step': False, 'taggers': ('<< >>', '\n'), 'prompt_youre_a_specialist': True, 'prompt_label_description': True, 'prompt_long_answer': True}
elif "falcon" in args.model_name and "cwlc" in args.dataset_name:
    kept_features = {'n_few_shot': 10, 'one_step': False, 'taggers': ('<< >>', '\n'),}
else:
